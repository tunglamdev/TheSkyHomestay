...
//           .mixed()
//           .required()
//           .test("fileFormat", "Bạn chỉ có thể chọn file ảnh", (value) => {
...
//         (image, index) =>
//           image?.ImageFile !== "" ||
//           image?.Caption !== roomImages[index]?.Caption ||
//           image?.IsDefault !== roomImages[index]?.IsDefault ||
//           image?.SortOrder !== roomImages[index]?.SortOrder,
//       );
//     }
//     setIsChanged(result);
//   }
...
//     if (content && props.roomId) {
//       if (content.Images?.length > 0) {
//         content.Images.forEach(async (image, index) => {
//           var updateImage = new FormData();

//           updateImage.append("Id", roomImages[index].Id);
//           updateImage.append(
//             "ImageFile",
//             image.ImageFile !== "" ? image.ImageFile[0] : null,
//           );
//           updateImage.append("RoomId", props.roomId);
//           updateImage.append(
//             "Caption",
//             image.Caption ? image.Caption : "Room Image",
//           );
//           updateImage.append(
//             "SortOrder",
...
//         isOpen: true,
//         color: "danger",
//         message: "Update room image failed",
//       });
//     }
//   };
...
//   useEffect(() => {
//     if (props.roomImages) {
//       setCakeImages(props.roomImages);
//       reset({
//         Images: roomImages?.map((image) => {
//           return {
//             Caption: image.Caption,
